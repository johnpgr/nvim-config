...
keymap("<C-p>", function() require("fzf-lua").files({ fzf_opts = { ["--layout"] = "reverse-list" } }) end, "Fzf Files Finder")
keymap("<C-f>", function() require("fzf-lua").live_grep({ fzf_opts = { ["--layout"] = "reverse-list" } }) end, "Fzf Live Grep")
...
keymap("]d", function() vim.diagnostic.goto_next() feedkeys("zz") end, { desc = "Better jump next diagnostic", remap = true }, "n")
keymap("[d", function() vim.diagnostic.goto_prev() feedkeys("zz") end, { desc = "Better jump prev diagnostic", remap = true }, "n")
...
keymap("<leader>tt", "<cmd>tabnew<cr><cmd>terminal<cr><cmd>keepalt file zsh<cr>", "Open terminal tab")
keymap("<leader>tn", "<cmd>tabnew<cr>", "Open new tab")
keymap("<Esc><Esc>", "<C-\\><C-n>", "Terminal mode easy exit", "t")
...
keymap("<leader>lf", function() require("conform").format({ async = true, lsp_fallback = true }) end, "LSP: Format buffer")
