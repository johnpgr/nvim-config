-- Sourced from https://github.com/Hubro/nvim-splitrun/blob/main/lua/nvim-splitrun/init.lua
...
function M.splitrun(command, opts)
  ...
  vim.api.nvim_buf_set_name(buf, string.format(M.buffer_name_fmt, M.buffer_counter))
