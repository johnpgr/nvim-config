...
keymap("<leader>b", ":Neotree toggle<cr>", "Neotree toggle")
...
keymap("<C-s>r", "<C-w>=", "Reset splits sizes")
keymap("<C-s>v", "<cmd>vsp<cr><C-w>l", "New vertical split (relative)")
keymap("<C-s>V", "<cmd>bo vsp<cr>", "New vertical split (absolute)")
keymap("<C-s>h", "<cmd>sp<cr>", "New horizontal split (relative)")
keymap("<C-s>H", "<cmd>bo sp<cr>", "New horizontal split (absolute)")
...
keymap("<A-r>", "<cmd>OverseerQuickAction restart<cr>", "Restart last task")
