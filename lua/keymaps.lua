...
keymap("<C-/>", telescope_builtin.resume, "Previous telescope picker")
keymap("<C-_>", telescope_builtin.resume, "Previous telescope picker")
...
keymap("<A-k>", utils.show_keymaps, "Show keymaps")
