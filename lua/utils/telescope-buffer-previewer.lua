-- Sourced from: https://github.com/miszo/dotfiles/blob/main/home/dot_config/exact_nvim/exact_lua/exact_utils/exact_telescope/buffer_previewer.lua
...
buffer_previewers.cat = defaulter(function(opts)
    ...
    return Previewers.new_buffer_previewer {
        title = "File Preview",
        dyn_title = function(_, entry) return Path:new(from_entry.path(entry, true)):normalize(cwd) end,

        get_buffer_by_name = function(_, entry) return from_entry.path(entry, true) end,
